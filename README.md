...
> [!TIP]
> - Installing Mod to single player.
>    1. Locate install directory for your game `Hytale > UserData > Mods` for single player.
>       - Locate mods directory for Server if multiplayer and add the below .zip
>    2. Click image link below, take note of how to download from the image.
